  ...
  try {
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 font-mono text-xs">
          ...
          <Panel className="p-4 space-y-1">
            <span className="text-[10px] uppercase font-bold text-rust">
    ...
    return (
      <div className="space-y-4">
        <PageHeader
          title="Knowledge Gaps & Health"
          description="Content governance and gap analysis"
        />
        <Panel className="p-6 border-status-bad/40 bg-status-bad/10">
          <h2 className="text-sm font-bold text-status-bad">Knowledge Health Diagnostics Notice</h2>
