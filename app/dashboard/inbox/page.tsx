  ...
  try {
    ...
    return (
      <div className="p-6 space-y-4">
        <PageHeader title="Customer Inbox" description="3-column Customer 360 intelligence inbox" />
        <Panel className="p-6 border-status-bad/40 bg-status-bad/10">
          <h2 className="text-sm font-bold text-status-bad">Inbox Diagnostics Notice</h2>
