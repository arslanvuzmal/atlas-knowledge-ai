      ...
      <div className="flex items-start gap-2.5">
        <span
          className={cn(
            ...
            highlighted
              ...
              : 'bg-accent-wash text-accent-soft border border-accent/20',
          )}
          aria-hidden="true"
        >
          {citation.ordinal}
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center justify-between gap-2">
            <p className="truncate text-xs font-semibold text-ink font-sans">
          ...
          {location ? (
            <p className="mt-0.5 truncate font-mono text-[10.5px] text-ink-faint">{location}</p>
          ) : null}
          {!compact ? (
